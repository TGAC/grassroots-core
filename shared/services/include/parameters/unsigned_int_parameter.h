 ...
 */
GRASSROOTS_SERVICE_API UnsignedIntParameter *AllocateUnsignedIntParameter (const struct ServiceData *service_data_p, const char * const name_s, const char * const display_name_s, const char * const description_s, const uint32 *default_value_p, const uint32 *current_value_p, ParameterLevel level);


GRASSROOTS_SERVICE_API UnsignedIntParameter *AllocateUnsignedIntParameterFromJSON (const json_t *param_json_p, const struct Service *service_p, const bool concise_flag);
...
GRASSROOTS_SERVICE_API const uint32 *GetUnsignedIntParameterCurrentValue (const UnsignedIntParameter *param_p);


GRASSROOTS_SERVICE_API bool SetUnsignedIntParameterCurrentValue (UnsignedIntParameter *param_p, const uint32 *value_p);


GRASSROOTS_SERVICE_API const uint32 *GetUnsignedIntParameterDefaultValue (const UnsignedIntParameter *param_p);


GRASSROOTS_SERVICE_API bool SetUnsignedIntParameterDefaultValue (UnsignedIntParameter *param_p, const uint32 *value_p);


GRASSROOTS_SERVICE_API bool SetUnsignedIntParameterBounds (UnsignedIntParameter *param_p, const uint32 min_value, const uint32 max_value);


GRASSROOTS_SERVICE_API bool IsUnsignedIntParameterBounded (const UnsignedIntParameter *param_p);


GRASSROOTS_SERVICE_API void GetUnsignedIntParameterBounds (const UnsignedIntParameter *param_p, const uint32 **min_pp, const uint32 **max_pp);


GRASSROOTS_SERVICE_API bool IsUnsignedIntParameter (const Parameter *param_p);


GRASSROOTS_SERVICE_API bool GetCurrentUnsignedIntParameterValueFromParameterSet (const ParameterSet * const params_p, const char * const name_s, const uint32 **value_pp);


GRASSROOTS_SERVICE_API bool CreateAndAddUnsignedIntParameterOption (UnsignedIntParameter *param_p, const uint32 value, const char *description_s);


GRASSROOTS_SERVICE_API UnsignedIntParameterOption *AllocateUnsignedIntParameterOption (const uint32 value, const char *description_s);


GRASSROOTS_SERVICE_API void FreeUnsignedIntParameterOption (UnsignedIntParameterOption *option_p);


GRASSROOTS_SERVICE_API UnsignedIntParameterOptionNode *AllocateUnsignedIntParameterOptionNode (UnsignedIntParameterOption *option_p);


GRASSROOTS_SERVICE_API void FreeStringParameterOptionNode (ListItem *item_p);


GRASSROOTS_SERVICE_API bool SetUnsignedIntParameterCurrentValueFromJSON (UnsignedIntParameter *param_p, const json_t *value_p);
