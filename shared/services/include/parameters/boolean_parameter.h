 ...
 */
GRASSROOTS_SERVICE_API BooleanParameter *AllocateBooleanParameter (const struct ServiceData *service_data_p, const char * const name_s, const char * const display_name_s, const char * const description_s, const bool *default_value_p, const bool *current_value_p, ParameterLevel level);


GRASSROOTS_SERVICE_API BooleanParameter *AllocateBooleanParameterFromJSON (const json_t *param_json_p, const struct Service *service_p, const bool concise_flag);
...
GRASSROOTS_SERVICE_API const bool *GetBooleanParameterCurrentValue (const BooleanParameter *param_p);


GRASSROOTS_SERVICE_API bool SetBooleanParameterCurrentValue (BooleanParameter *param_p, const bool *value_p);


GRASSROOTS_SERVICE_API const bool *GetBooleanParameterDefaultValue (const BooleanParameter *param_p);


GRASSROOTS_SERVICE_API bool SetBooleanParameterDefaultValue (BooleanParameter *param_p, const bool *value_p);


GRASSROOTS_SERVICE_API bool IsBooleanParameter (const Parameter *param_p);


GRASSROOTS_SERVICE_API bool GetCurrentBooleanParameterValueFromParameterSet (const ParameterSet * const params_p, const char * const name_s, const bool **value_pp);


GRASSROOTS_SERVICE_API bool SetBooleanParameterCurrentValueFromJSON (BooleanParameter *param_p, const json_t *value_p);
