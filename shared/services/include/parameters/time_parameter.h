 ...
 */
GRASSROOTS_SERVICE_API TimeParameter *AllocateTimeParameter (const struct ServiceData *service_data_p,
...
GRASSROOTS_SERVICE_API TimeParameter *AllocateTimeParameterFromJSON (const json_t *param_json_p, const struct Service *service_p, const bool concise_flag);
...
GRASSROOTS_SERVICE_API const struct tm *GetTimeParameterCurrentValue (const TimeParameter *param_p);


GRASSROOTS_SERVICE_API bool SetTimeParameterCurrentValue (TimeParameter *param_p, const struct tm *value_p);


GRASSROOTS_SERVICE_API const struct tm *GetTimeParameterDefaultValue (const TimeParameter *param_p);


GRASSROOTS_SERVICE_API bool SetTimeParameterDefaultValue (TimeParameter *param_p, const struct tm *value_p);


GRASSROOTS_SERVICE_API bool IsTimeParameter (Parameter *param_p);


GRASSROOTS_SERVICE_API bool GetCurrentTimeParameterValueFromParameterSet (const ParameterSet * const params_p, const char * const name_s, const struct tm **value_pp);


GRASSROOTS_SERVICE_API bool SetTimeParameterCurrentValueFromJSON (TimeParameter *param_p, const json_t *value_p);
