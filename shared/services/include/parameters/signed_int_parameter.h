 ...
 */
GRASSROOTS_SERVICE_API SignedIntParameter *AllocateSignedIntParameter (const struct ServiceData *service_data_p, const ParameterType pt,
...
GRASSROOTS_SERVICE_API SignedIntParameter *AllocateSignedIntParameterFromJSON (const json_t *param_json_p, const struct Service *service_p, const bool concise_flag);



GRASSROOTS_SERVICE_API void FreeSignedIntParameter (SignedIntParameter *param_p);
...
GRASSROOTS_SERVICE_API bool SetSignedIntParameterCurrentValue (SignedIntParameter *param_p, const int32 *value_p);


GRASSROOTS_SERVICE_API const int32 *GetSignedIntParameterDefaultValue (const SignedIntParameter *param_p);


GRASSROOTS_SERVICE_API bool SetSignedIntParameterDefaultValue (SignedIntParameter *param_p, const int32 *value_p);


GRASSROOTS_SERVICE_API bool SetSignedIntParameterBounds (SignedIntParameter *param_p, const int32 min_value, const int32 max_value);


GRASSROOTS_SERVICE_API bool IsSignedIntParameterBounded (const SignedIntParameter *param_p);


GRASSROOTS_SERVICE_API void GetSignedIntParameterBounds (const SignedIntParameter *param_p, const int32 **min_pp, const int32 **max_pp);


GRASSROOTS_SERVICE_API bool IsSignedIntParameter (const Parameter *param_p);


GRASSROOTS_SERVICE_API bool GetCurrentSignedIntParameterValueFromParameterSet (const ParameterSet * const params_p, const char * const name_s, const int32 **value_pp);


GRASSROOTS_SERVICE_API bool CreateAndAddSignedIntParameterOption (SignedIntParameter *param_p, const int32 value, const char *description_s);


GRASSROOTS_SERVICE_API SignedIntParameterOption *AllocateSignedIntParameterOption (const int32 value, const char *description_s);


GRASSROOTS_SERVICE_API void FreeSignedIntParameterOption (SignedIntParameterOption *option_p);


GRASSROOTS_SERVICE_API SignedIntParameterOptionNode *AllocateSignedIntParameterOptionNode (SignedIntParameterOption *option_p);


GRASSROOTS_SERVICE_API void FreeStringParameterOptionNode (ListItem *item_p);


GRASSROOTS_SERVICE_API bool SetSignedIntParameterCurrentValueFromJSON (SignedIntParameter *param_p, const json_t *value_p);
