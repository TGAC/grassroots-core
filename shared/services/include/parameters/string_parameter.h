 ...
 */
GRASSROOTS_SERVICE_API StringParameter *AllocateStringParameter (const struct ServiceData *service_data_p, const ParameterType pt, const char * const name_s, const char * const display_name_s, const char * const description_s, const char *default_value_p, const char *current_value_p, ParameterLevel level);


GRASSROOTS_SERVICE_API StringParameter *AllocateStringParameterFromJSON (const json_t *param_json_p, const struct Service *service_p, const bool concise_flag, const ParameterType *pt_p);
...
GRASSROOTS_SERVICE_API void FreeStringParameter (StringParameter *param_p);


GRASSROOTS_SERVICE_API const char *GetStringParameterCurrentValue (const StringParameter *param_p);


GRASSROOTS_SERVICE_API bool SetStringParameterCurrentValue (StringParameter *param_p, const char *value_p);


GRASSROOTS_SERVICE_API const char *GetStringParameterDefaultValue (const StringParameter *param_p);


GRASSROOTS_SERVICE_API bool SetStringParameterDefaultValue (StringParameter *param_p, const char *value_p);


GRASSROOTS_SERVICE_API bool SetStringParameterBounds (StringParameter *param_p, const char *min_value_s, const char *max_value_s);


GRASSROOTS_SERVICE_API bool IsStringParameterBounded (const StringParameter *param_p);
...
GRASSROOTS_SERVICE_API StringParameterOptionNode *AllocateStringParameterOptionNode (StringParameterOption *option_p);


GRASSROOTS_SERVICE_API void FreeStringParameterOption (StringParameterOption *option_p);


GRASSROOTS_SERVICE_API bool IsStringParameter (const Parameter *param_p);
 ...
 */
GRASSROOTS_SERVICE_API bool GetCurrentStringParameterValueFromParameterSet (const ParameterSet * const params_p, const char * const name_s, const char **value_pp);



GRASSROOTS_SERVICE_API bool GetCurrentStringParameterValueFromParameterGroup (const ParameterGroup * const params_p, const char * const name_s, const char **value_pp);
