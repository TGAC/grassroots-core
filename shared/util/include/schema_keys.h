...
SCHEMA_KEYS_PREFIX const char *CONTEXT_URL_STATS_ONTOLOGY_S SCHEMA_KEYS_VAL("http://purl.obolibrary.org/obo/STATO_");
	...
	SCHEMA_KEYS_PREFIX const char *PARAM_LEVEL_TEXT_WIZARD_S  SCHEMA_KEYS_VAL("wizard");

	SCHEMA_KEYS_PREFIX const char *PARAM_LEVEL_TEXT_ALL_AND_WIZARD_S  SCHEMA_KEYS_VAL("all | wizard");
