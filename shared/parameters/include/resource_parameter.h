 ...
 */
GRASSROOTS_PARAMS_API ResourceParameter *AllocateResourceParameter (const struct ServiceData *service_data_p, const ParameterType pt, const char * const name_s, const char * const display_name_s, const char * const description_s, LinkedList *options_p, Resource *default_value_p, Resource *current_value_p, ParameterLevel level);
