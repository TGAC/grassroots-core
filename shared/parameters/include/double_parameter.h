...
GRASSROOTS_PARAMS_API DoubleParameter *AllocateDoubleParameterFromJSON (const json_t *param_json_p, const struct Service *service_p, const bool concise_flag);
...
GRASSROOTS_PARAMS_API bool SetDoubleParameterBounds (DoubleParameter *param_p, const double64 *min_value_p, const double64 *max_value_p);
...
GRASSROOTS_PARAMS_API bool SetDoubleParameterMinimumValue (DoubleParameter *param_p, const double64 *min_value_p);
