...
*/
  ...
  #ifdef  GRASSROOTS_HANDLER_LIBRARY_EXPORTS /* defined if we are building the LIB DLL (instead of using it) */
    #define GRASSROOTS_HANDLER_API LIB_HELPER_SYMBOL_EXPORT
  #else
    #define GRASSROOTS_HANDLER_API LIB_HELPER_SYMBOL_IMPORT
  #endif /* #ifdef GRASSROOTS_HANDLER_MANAGER_LIBRARY_EXPORTS */
  #define GRASSROOTS_HANDLER_LOCAL LIB_HELPER_SYMBOL_LOCAL
#else /* SHARED_LIBRARY is not defined: this means LIB is a static lib. */
  #define GRASSROOTS_HANDLER_API
  #define GRASSROOTS_HANDLER_LOCAL
...
#endif 	/* #ifndef GRASSROOTS_HANDLER_LIBRARY_H */
