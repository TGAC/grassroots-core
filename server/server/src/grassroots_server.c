...
static json_t *GetInterestedServices (GrassrootsServer *grassroots_p, const json_t * const req_p, User *user_p);

static json_t *GetAllServices (GrassrootsServer *grassroots_p, const json_t * const req_p, User *user_p);

static json_t *RunKeywordServices (GrassrootsServer *grassroots_p, const json_t * const req_p, User *user_p, const char *keyword_s);

static json_t *GetServiceResultsAsJSON (GrassrootsServer *grassroots_p, const json_t * const req_p, User *user_p);

static json_t *GetServicesAsJSON (GrassrootsServer *grassroots_p, User *user_p, DataResource *resource_p, Handler *handler_p, ProvidersStateTable *providers_p);

//static json_t *GetNamedServices (GrassrootsServer *grassroots_p, const json_t * const req_p, User *user_p);

//static json_t *GetNamedServiceInfo (GrassrootsServer *grassroots_p, const json_t * const req_p, User *user_p);


static json_t *GetNamedServicesFunctionality (GrassrootsServer *grassroots_p, const json_t * const req_p, User *user_p, Operation op);

static json_t *GetServiceData (GrassrootsServer *grassroots_p, const json_t * const req_p, User *user_p, bool (*callback_fn) (GrassrootsServer *grassroots_p, json_t *services_p, uuid_t service_id, const char *uuid_s));

static int8 ProcessServiceFromJSON (GrassrootsServer *grassroots_p, const json_t *service_req_p, const json_t *paired_servers_req_p, User *user_p, json_t *res_p, uuid_t user_uuid, const char **key_ss);
...
static json_t *GetServerStatus (GrassrootsServer *grassroots_p, const json_t * const req_p, User *user_p);

static json_t *GetRequestedResource (GrassrootsServer *grassroots_p, const json_t * const req_p, User *user_p);

static json_t *GenerateNamedServices (GrassrootsServer *grassroots_p, LinkedList *services_p, const json_t * const req_p, User *user_p, ProvidersStateTable *providers_p);

static int32 AddPairedServices (GrassrootsServer *grassroots_p, Service *internal_service_p, User *user_p, ProvidersStateTable *providers_p);

static int32 AddAllPairedServices (GrassrootsServer *grassroots_p, LinkedList *internal_services_p, User *user_p, ProvidersStateTable *providers_p);

static json_t *GenerateServiceIndexingData (GrassrootsServer *grassroots_p, LinkedList *services_p, const json_t * const req_p, User *user_p, ProvidersStateTable *providers_p);

static LinkedList *GetServicesList (GrassrootsServer *grassroots_p, User *user_p, DataResource *resource_p, Handler *handler_p, ProvidersStateTable *providers_p);
...
static void ProcessServiceRequest (const json_t *service_req_p, json_t *services_res_p, GrassrootsServer *grassroots_p, ProvidersStateTable *providers_p, const char *server_s, User *user_p, Operation op);

static int8 RunServiceFromJSON (GrassrootsServer *grassroots_p, Service *service_p, const json_t *service_req_p, const json_t *paired_servers_req_p, User *user_p, json_t *res_p);
...
static int8 GetServiceIndexingInformation (GrassrootsServer *grassroots_p, Service *service_p, const json_t *service_req_p, const json_t *paired_servers_req_p, User *user_p, json_t *res_p);
...
static uint32 FindMatchingServices(GrassrootsServer *grassroots_p, ServiceMatcher *matcher_p,
																	 User *user_p, const json_t *reference_config_p,
...
static bool AddUserToResponse (json_t *res_p, User *user_p);
 ...
 */
							 ...
							 if (service_results_p)
								 {
									 ...
									 if (key_s)
										 {
											 res_p = GetInitialisedResponseOnServer (grassroots_p, user_p, json_req_p, key_s, service_results_p);
	 ...
	 if (res_p)
		 {
			 ...
			 if (user_p)
				 {
					 if (!AddUserToResponse (res_p, user_p))
						 {
 ...
 static bool AddUserToResponse (json_t *res_p, User *user_p)
 {
	 ...
	 if (user_json_p)
		 {
			 if (json_object_set_new (res_p, USER_S, user_json_p) == 0)
				 {
					 success_flag = true;
				 }
			 else
...
User *GetUserByEmailAddress (const GrassrootsServer *grassroots_p, const char *email_s)
 {
	 ...
	 if (user_db_config_p)
		 {
			 const char *db_s = GetJSONString (user_db_config_p, "database");
			 const char *collection_s = GetJSONString (user_db_config_p, "users_collection");

			 if (db_s && collection_s)
				 {
					 ...
					 if (providers_p)
						 {
							 ...
							 if (services_p)
								 {
									 res_p = GetInitialisedResponseOnServer (grassroots_p, user_p, req_p, SERVICES_NAME_S, services_p);
	 ...
	 if (providers_p)
		 {
			 ...
			 if (services_p)
				 {
					 json_t *res_p = GetInitialisedResponseOnServer (grassroots_p, user_p, req_p, SERVICES_NAME_S, services_p);
 ...
 static json_t *RunKeywordServices (GrassrootsServer *grassroots_p, const json_t * const req_p, User *user_p, const char *keyword_s)
 {
	 ...
	 if (results_p)
		 {
			 res_p = GetInitialisedResponseOnServer (grassroots_p, user_p, req_p, SERVICE_RESULTS_S, results_p);
...
static json_t *GetNamedServiceInfo (GrassrootsServer *grassroots_p, const json_t * const req_p, User *user_p)
{
			 ...
			 if (providers_p)
				 {
					 ...
					 res_p = GetInitialisedResponseOnServer (grassroots_p, user_p, req_p, SERVICES_NAME_S, services_res_p);
 ...
 static json_t *GenerateNamedServices (GrassrootsServer *grassroots_p, LinkedList *services_p, const json_t * const req_p, User *user_p, ProvidersStateTable *providers_p)
 {
	 ...
	 if (services_json_p)
		 {
			 res_p = GetInitialisedResponseOnServer (grassroots_p, user_p, req_p, SERVICES_NAME_S, services_json_p);
...
#if IRODS_ENABLED == 1
 static json_t *GetAllModifiedData (const json_t * const req_p, User *user_p)
 {
	 json_t *res_p = NULL;
 ...
 static uint32 GetMatchingReferrableServices (GrassrootsServer *grassroots_p, ServiceMatcher *matcher_p, User *user_p, const json_t *reference_config_p, LinkedList *services_list_p, bool multiple_match_flag)
 {
	 return FindMatchingServices (grassroots_p, matcher_p, user_p, reference_config_p, services_list_p, multiple_match_flag, false);
 }


 static uint32 GetMatchingServices (GrassrootsServer *grassroots_p, ServiceMatcher *matcher_p, User *user_p,  LinkedList *services_list_p, bool multiple_match_flag)
 {
	 return FindMatchingServices (grassroots_p, matcher_p, user_p, NULL, services_list_p, multiple_match_flag, true);
 }


 static uint32 FindMatchingServices (GrassrootsServer *grassroots_p, ServiceMatcher *matcher_p, User *user_p, const json_t *reference_config_p, LinkedList *services_list_p, bool multiple_match_flag, bool native_services_flag)
 {
