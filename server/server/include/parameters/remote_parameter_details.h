 ...
 */
GRASSROOTS_SERVICE_MANAGER_API	RemoteParameterDetails *AllocateRemoteParameterDetails (const char * const uri_s, const char * const param_s);
 ...
 * @memberof RemoteParameterDetails
 */
GRASSROOTS_SERVICE_MANAGER_API	void FreeRemoteParameterDetails (RemoteParameterDetails *details_p);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API	RemoteParameterDetailsNode *AllocateRemoteParameterDetailsNode (RemoteParameterDetails *details_p);
 ...
 * @return The new RemoteParameterDetailsNode or <code>NULL</code> upon error.
 */
GRASSROOTS_SERVICE_MANAGER_API	RemoteParameterDetailsNode *AllocateRemoteParameterDetailsNodeByParts (const char * const uri_s,  const char * const param_s);
 ...
 * @memberof RemoteParameterDetailsNode
 */
GRASSROOTS_SERVICE_MANAGER_API	void FreeRemoteParameterDetailsNode (ListItem *node_p);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API	json_t *GetRemoteParameterDetailsAsJSON (const RemoteParameterDetails *details_p);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API	RemoteParameterDetails *CreateRemoteParameterDetailsFromJSON (const json_t *json_p);
