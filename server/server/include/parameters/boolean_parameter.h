 ...
 */
GRASSROOTS_SERVICE_MANAGER_API BooleanParameter *AllocateBooleanParameter (const struct ServiceData *service_data_p, const char * const name_s, const char * const display_name_s, const char * const description_s, const bool *default_value_p, const bool *current_value_p, ParameterLevel level);


GRASSROOTS_SERVICE_MANAGER_API BooleanParameter *AllocateBooleanParameterFromJSON (const json_t *param_json_p, const struct Service *service_p, const bool concise_flag);


GRASSROOTS_SERVICE_MANAGER_API Parameter *EasyCreateAndAddBooleanParameterToParameterSet (const struct ServiceData *service_data_p, ParameterSet *params_p, ParameterGroup *group_p,
											      													const char * const name_s, const char * const display_name_s, const char * const description_s,
														      										const bool *default_value_p, uint8 level);



GRASSROOTS_SERVICE_MANAGER_API Parameter *CreateAndAddBooleanParameterToParameterSet (const struct ServiceData *service_data_p, ParameterSet *params_p, ParameterGroup *group_p,
																											const char * const name_s, const char * const display_name_s, const char * const description_s,
																											const bool *default_value_p, const bool *current_value_p, uint8 level);


GRASSROOTS_SERVICE_MANAGER_API void FreeBooleanParameter (BooleanParameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API const bool *GetBooleanParameterCurrentValue (const BooleanParameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API bool SetBooleanParameterCurrentValue (BooleanParameter *param_p, const bool *value_p);


GRASSROOTS_SERVICE_MANAGER_API const bool *GetBooleanParameterDefaultValue (const BooleanParameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API bool SetBooleanParameterDefaultValue (BooleanParameter *param_p, const bool *value_p);


GRASSROOTS_SERVICE_MANAGER_API bool IsBooleanParameter (const Parameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API bool GetCurrentBooleanParameterValueFromParameterSet (const ParameterSet * const params_p, const char * const name_s, const bool **value_pp);


GRASSROOTS_SERVICE_MANAGER_API bool SetBooleanParameterCurrentValueFromJSON (BooleanParameter *param_p, const json_t *value_p);
