 ...
 */
GRASSROOTS_SERVICE_MANAGER_API ResourceParameter *AllocateResourceParameter (const struct ServiceData *service_data_p, const ParameterType pt, const char * const name_s, const char * const display_name_s, const char * const description_s, DataResource *default_value_p, DataResource *current_value_p, ParameterLevel level);


GRASSROOTS_SERVICE_MANAGER_API ResourceParameter *AllocateResourceParameterFromJSON (const json_t *param_json_p, const struct Service *service_p, const bool concise_flag);


GRASSROOTS_SERVICE_MANAGER_API void FreeResourceParameter (ResourceParameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API const DataResource *GetResourceParameterCurrentValue (const ResourceParameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API bool SetResourceParameterCurrentValue (ResourceParameter *param_p, const DataResource *value_p);


GRASSROOTS_SERVICE_MANAGER_API const DataResource *GetResourceParameterDefaultValue (const ResourceParameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API bool SetResourceParameterDefaultValue (ResourceParameter *param_p, const DataResource *value_p);


GRASSROOTS_SERVICE_MANAGER_API bool GetCurrentResourceParameterValueFromParameterSet (const ParameterSet * const params_p, const char * const name_s, const DataResource **value_pp);


GRASSROOTS_SERVICE_MANAGER_API bool IsResourceParameter (const Parameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API bool SetResourceParameterCurrentValueFromJSON (ResourceParameter *param_p, const json_t *value_p);
