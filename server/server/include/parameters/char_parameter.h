 ...
 */
GRASSROOTS_SERVICE_MANAGER_API CharParameter *AllocateCharParameter (const struct ServiceData *service_data_p, const char * const name_s, const char * const display_name_s, const char * const description_s, const char *default_value_p, const char *current_value_p, ParameterLevel level);


GRASSROOTS_SERVICE_MANAGER_API CharParameter *AllocateCharParameterFromJSON (const json_t *param_json_p, const struct Service *service_p, const bool concise_flag);


GRASSROOTS_SERVICE_MANAGER_API void FreeCharParameter (CharParameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API const char *GetCharParameterCurrentValue (const CharParameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API bool SetCharParameterCurrentValue (CharParameter *param_p, const char *value_p);


GRASSROOTS_SERVICE_MANAGER_API const char *GetCharParameterDefaultValue (const CharParameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API bool SetCharParameterDefaultValue (CharParameter *param_p, const char *value_p);


GRASSROOTS_SERVICE_MANAGER_API bool SetCharParameterBounds (CharParameter *param_p, const char min_value, const char max_value);


GRASSROOTS_SERVICE_MANAGER_API bool IsCharParameterBounded (const CharParameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API bool GetCharParameterBounds (const CharParameter *param_p, char *min_p, char *max_p);


GRASSROOTS_SERVICE_MANAGER_API bool IsCharParameter (Parameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API bool GetCurrentCharParameterValueFromParameterSet (const ParameterSet * const params_p, const char * const name_s, const char **value_pp);



GRASSROOTS_SERVICE_MANAGER_API Parameter *EasyCreateAndAddCharParameterToParameterSet (const struct ServiceData *service_data_p, ParameterSet *params_p, ParameterGroup *group_p,
																								const char * const name_s, const char * const display_name_s, const char * const description_s,
																								const char *default_value_p, uint8 level);


GRASSROOTS_SERVICE_MANAGER_API Parameter *CreateAndAddCharParameterToParameterSet (const struct ServiceData *service_data_p, ParameterSet *params_p, ParameterGroup *group_p,
																								const char * const name_s, const char * const display_name_s, const char * const description_s,
																								const char *default_value_p, const char *current_value_p, uint8 level);


GRASSROOTS_SERVICE_MANAGER_API bool SetCharParameterCurrentValueFromJSON (CharParameter *param_p, const json_t *value_p);
