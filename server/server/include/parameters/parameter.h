...
typedef struct ParameterNode
{
	...
	#define PARAMETER_PREFIX  GRASSROOTS_SERVICE_MANAGER_API
	#define PARAMETER_VAL(x) = x
	#define PARAMETER_CONCAT_VAL(x,y) = x y
#else
	#define PARAMETER_PREFIX extern GRASSROOTS_SERVICE_MANAGER_API
...
GRASSROOTS_SERVICE_MANAGER_API bool InitParameter (Parameter *param_p, const struct ServiceData *service_data_p, ParameterType type, const char * const name_s,
...
GRASSROOTS_SERVICE_MANAGER_API bool InitParameterFromJSON (Parameter *param_p, const json_t * const root_p, const struct Service *service_p, const bool concise_flag, const ParameterType *pt_p);


GRASSROOTS_SERVICE_MANAGER_API bool AddParameterValuesToJSON (const Parameter *param_p, json_t *param_json_p, const bool full_definition_flag);
 ...
 * @memberof Parameter
 */
GRASSROOTS_SERVICE_MANAGER_API Parameter *CloneParameter (const Parameter * const src_p, const struct ServiceData *data_p);
 ...
 * @memberof Parameter
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeParameter (Parameter *param_p);
 ...
 * @memberof Parameter
 */
GRASSROOTS_SERVICE_MANAGER_API void ClearParameter (Parameter *param_p);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API bool CompareParameterLevels (const ParameterLevel param_level, const ParameterLevel threshold);
 ...
 * @memberof Parameter
 */
GRASSROOTS_SERVICE_MANAGER_API const char *CheckForSignedReal (const Parameter * const parameter_p, const void *value_p);
 ...
 * @memberof Parameter
 */
GRASSROOTS_SERVICE_MANAGER_API const char *CheckForNotNull (const Parameter * const parameter_p, const void *value_p);
 ...
 * @memberof Parameter
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddParameterKeyStringValuePair (Parameter * const parameter_p, const char *key_s, const char *value_s);


GRASSROOTS_SERVICE_MANAGER_API bool AddParameterKeyJSONValuePair (Parameter * const parameter_p, const char *key_s, const json_t *value_p);


GRASSROOTS_SERVICE_MANAGER_API bool AddColumnParameterHint (const char *name_s, const char *description_s, const ParameterType param_type, const bool required_flag, json_t *array_p);
 ...
 * @memberof Parameter
 */
GRASSROOTS_SERVICE_MANAGER_API void RemoveParameterKeyValuePair (Parameter * const parameter_p, const char *key_s);
 ...
 * @memberof Parameter
 */
GRASSROOTS_SERVICE_MANAGER_API const char *GetParameterKeyValue (const Parameter * const parameter_p, const char *key_s);
 ...
 * @memberof Parameter
 */
GRASSROOTS_SERVICE_MANAGER_API json_t *GetParameterAsJSON (const Parameter * const parameter_p, const SchemaVersion * const sv_p, const bool full_definition_flag);
 ...
 * @memberof Parameter
 */
GRASSROOTS_SERVICE_MANAGER_API Parameter *CreateParameterFromJSON (const json_t * const root_p, struct Service *service_p, const bool concise_flag);
 ...
 * @memberof Parameter
 */
GRASSROOTS_SERVICE_MANAGER_API bool IsJSONParameterConcise (const json_t * const json_p);
 ...
 * @memberof Parameter
 */
GRASSROOTS_SERVICE_MANAGER_API const char *GetUIName (const Parameter * const parameter_p);
 ...
 * @memberof Parameter
 */
GRASSROOTS_SERVICE_MANAGER_API char *GetParameterValueAsString (const Parameter * const param_p, bool *alloc_flag_p);
 ...
 * @memberof Parameter
 */
GRASSROOTS_SERVICE_MANAGER_API bool SetParameterValueFromString (Parameter * const param_p, const char *value_s);
 ...
 * @memberof Parameter
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddRemoteDetailsToParameter (Parameter *param_p, const char * const uri_s, const char * const name_s);
 ...
 * @memberof Parameter
 */
GRASSROOTS_SERVICE_MANAGER_API bool CopyRemoteParameterDetails (const Parameter * const src_param_p, Parameter *dest_param_p);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API const char *GetGrassrootsTypeAsString (const ParameterType param_type);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API bool GetGrassrootsTypeFromString (const char *param_type_s, ParameterType *param_type_p);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API bool GetParameterGroupVisibility (const struct ServiceData *service_data_p, const char *group_name_s, bool *visibility_p);
 ...
 * @memberof Parameter
 */
GRASSROOTS_SERVICE_MANAGER_API bool GetParameterDescriptionFromConfig (const struct ServiceData *service_data_p, const char *param_name_s, char **description_ss);
 ...
 * @memberof Parameter
 */
GRASSROOTS_SERVICE_MANAGER_API bool GetParameterDisplayNameFromConfig (const struct ServiceData *service_data_p, const char *param_name_s, char **display_name_ss);
 ...
 * @memberof Parameter
 */
GRASSROOTS_SERVICE_MANAGER_API bool GetParameterLevelFromConfig (const struct ServiceData *service_data_p, const char *param_name_s, ParameterLevel *level_p);
 ...
 * @memberof Parameter
 */
GRASSROOTS_SERVICE_MANAGER_API const char *GetParameterLevelAsString (const ParameterLevel level);
 ...
 * @memberof Parameter
 */
GRASSROOTS_SERVICE_MANAGER_API bool GetParameterLevelFromString (const char *level_s, ParameterLevel *level_p);
 ...
 * @memberof Parameter
 */
GRASSROOTS_SERVICE_MANAGER_API ParameterNode *AllocateParameterNode (Parameter *param_p);
 ...
 * @memberof Parameter,
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeParameterNode (ListItem *node_p);
 ...
 * @memberof Parameter
 */
GRASSROOTS_SERVICE_MANAGER_API json_t *GetRunnableParameterAsJSON (const Parameter *param_p, const SchemaVersion * const sv_p, const bool full_definition_flag);


GRASSROOTS_SERVICE_MANAGER_API bool AddParameterLevelToJSON (const ParameterLevel level, json_t *root_p, const SchemaVersion * const UNUSED_PARAM (sv_p));



GRASSROOTS_SERVICE_MANAGER_API void SetParameterCallbacks (Parameter *param_p, void (*clear_fn) (Parameter *param_p),
														bool (*add_values_to_json_fn) (const Parameter *param_p, json_t *param_json_p, const bool full_definition_flag),
...
GRASSROOTS_SERVICE_MANAGER_API const json_t *GetParameterFromConfig (const json_t *service_config_p, const char * const param_name_s);



GRASSROOTS_SERVICE_MANAGER_LOCAL bool AddNullParameterValueToJSON (json_t *param_json_p, const char *key_s);



GRASSROOTS_SERVICE_MANAGER_API bool SetParameterCurrentValueFromJSON (Parameter *param_p, const json_t *value_p);
