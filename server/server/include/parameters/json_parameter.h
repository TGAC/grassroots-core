...
typedef struct JSONParameter
{
	...
	#define JSON_PARAM_PREFIX GRASSROOTS_SERVICE_MANAGER_API
	#define JSON_PARAM_VAL(x)	= x
#else
	#define JSON_PARAM_PREFIX extern GRASSROOTS_SERVICE_MANAGER_API
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API JSONParameter *AllocateJSONParameter (const struct ServiceData *service_data_p, const ParameterType pt, const char * const name_s, const char * const display_name_s, const char * const description_s, const json_t *default_value_p, const json_t *current_value_p, ParameterLevel level);



GRASSROOTS_SERVICE_MANAGER_API JSONParameter *AllocateJSONParameterFromJSON (const json_t *param_json_p, const struct Service *service_p, const bool concise_flag, const ParameterType *pt_p);


GRASSROOTS_SERVICE_MANAGER_API Parameter *EasyCreateAndAddJSONParameterToParameterSet (const struct ServiceData *service_data_p, ParameterSet *params_p, ParameterGroup *group_p, ParameterType type,
																											const char * const name_s, const char * const display_name_s, const char * const description_s,
																											const json_t *default_value_p, uint8 level);


GRASSROOTS_SERVICE_MANAGER_API Parameter *CreateAndAddJSONParameterToParameterSet (const struct ServiceData *service_data_p, ParameterSet *params_p, ParameterGroup *group_p, ParameterType type,
																											const char * const name_s, const char * const display_name_s, const char * const description_s,
																											const json_t *default_value_p, const json_t *current_value_p, uint8 level);


GRASSROOTS_SERVICE_MANAGER_API void FreeJSONParameter (JSONParameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API const json_t *GetJSONParameterCurrentValue (const JSONParameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API bool SetJSONParameterCurrentValue (JSONParameter *param_p, const json_t *value_p);


GRASSROOTS_SERVICE_MANAGER_API const json_t *GetJSONParameterDefaultValue (const JSONParameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API bool SetJSONParameterDefaultValue (JSONParameter *param_p, const json_t *value_p);


GRASSROOTS_SERVICE_MANAGER_API bool IsJSONParameter (Parameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API bool GetCurrentJSONParameterValueFromParameterSet (const ParameterSet * const params_p, const char * const name_s, const json_t **value_pp);


GRASSROOTS_SERVICE_MANAGER_API bool SetJSONParameterCurrentValueFromJSON (JSONParameter *param_p, const json_t *value_p);
