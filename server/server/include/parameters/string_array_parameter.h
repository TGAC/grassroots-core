 ...
 */
GRASSROOTS_SERVICE_MANAGER_API StringArrayParameter *AllocateStringArrayParameter (const struct ServiceData *service_data_p,  const char * const name_s, const char * const display_name_s, const char * const description_s, char **default_value_ss, char **current_value_ss, const size_t num_values, ParameterLevel level);


GRASSROOTS_SERVICE_MANAGER_API StringArrayParameter *AllocateStringArrayParameterFromJSON (const json_t *param_json_p, const struct Service *service_p, const bool concise_flag, const ParameterType *pt_p);



GRASSROOTS_SERVICE_MANAGER_API Parameter *EasyCreateAndAddStringArrayParameterToParameterSet (const ServiceData *service_data_p, ParameterSet *params_p, ParameterGroup *group_p,
																											const char * const name_s, const char * const display_name_s, const char * const description_s,
																											char **default_values_ss, uint32 num_entries, uint8 level);

GRASSROOTS_SERVICE_MANAGER_API Parameter *CreateAndAddStringArrayParameterToParameterSet (const ServiceData *service_data_p, ParameterSet *params_p, ParameterGroup *group_p,
																											const char * const name_s, const char * const display_name_s, const char * const description_s,
																											char **default_value_ss, char **current_value_ss, uint32 num_entries, uint8 level);


GRASSROOTS_SERVICE_MANAGER_API char *GetStringArrayParameterCurrentValuesAsFlattenedString (const StringArrayParameter *param_p);

GRASSROOTS_SERVICE_MANAGER_API void FreeStringArrayParameter (StringArrayParameter *param_p);

GRASSROOTS_SERVICE_MANAGER_API bool IsStringArrayParameter (const Parameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API const char **GetStringArrayParameterCurrentValues (const StringArrayParameter *param_p);

GRASSROOTS_SERVICE_MANAGER_API const char **GetStringArrayParameterDefaultValues (const StringArrayParameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API bool SetStringArrayParameterCurrentValues (StringArrayParameter *param_p, char **values_ss, const size_t num_values);

GRASSROOTS_SERVICE_MANAGER_API bool SetStringArrayParameterDefaultValues (StringArrayParameter *param_p, char **values_ss, const size_t num_values);


GRASSROOTS_SERVICE_MANAGER_API size_t GetNumberOfStringArrayCurrentParameterValues (const StringArrayParameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API char **CopyStringArray (char **src_ss, const size_t num_values);
