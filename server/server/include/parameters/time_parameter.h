 ...
 */
GRASSROOTS_SERVICE_MANAGER_API TimeParameter *AllocateTimeParameter (const struct ServiceData *service_data_p,
...
GRASSROOTS_SERVICE_MANAGER_API TimeParameter *AllocateTimeParameterFromJSON (const json_t *param_json_p, const struct Service *service_p, const bool concise_flag);


GRASSROOTS_SERVICE_MANAGER_API Parameter *EasyCreateAndAddTimeParameterToParameterSet (const struct ServiceData *service_data_p, ParameterSet *params_p, ParameterGroup *group_p,
																								const char * const name_s, const char * const display_name_s, const char * const description_s,
																								const struct tm *default_value_p, uint8 level);

GRASSROOTS_SERVICE_MANAGER_API Parameter *CreateAndAddTimeParameterToParameterSet (const struct ServiceData *service_data_p, ParameterSet *params_p, ParameterGroup *group_p,
																								const char * const name_s, const char * const display_name_s, const char * const description_s,
																								const struct tm *default_value_p, const struct tm *current_value_p, uint8 level);


GRASSROOTS_SERVICE_MANAGER_API void FreeTimeParameter (TimeParameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API const struct tm *GetTimeParameterCurrentValue (const TimeParameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API bool SetTimeParameterCurrentValue (TimeParameter *param_p, const struct tm *value_p);


GRASSROOTS_SERVICE_MANAGER_API const struct tm *GetTimeParameterDefaultValue (const TimeParameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API bool SetTimeParameterDefaultValue (TimeParameter *param_p, const struct tm *value_p);


GRASSROOTS_SERVICE_MANAGER_API bool IsTimeParameter (Parameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API bool GetCurrentTimeParameterValueFromParameterSet (const ParameterSet * const params_p, const char * const name_s, const struct tm **value_pp);


GRASSROOTS_SERVICE_MANAGER_API bool SetTimeParameterCurrentValueFromJSON (TimeParameter *param_p, const json_t *value_p);
