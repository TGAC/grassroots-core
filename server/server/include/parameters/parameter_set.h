 ...
 */
GRASSROOTS_SERVICE_MANAGER_API ParameterSet *AllocateParameterSet (const char *name_s, const char *description_s);
 ...
 * @memberof ParameterSet
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeParameterSet (ParameterSet *params_p);
 ...
 * @memberof ParameterSet
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddParameterToParameterSet (ParameterSet *params_p, Parameter *param_p);
 ...
 * @memberof ParameterSet
 */
GRASSROOTS_SERVICE_MANAGER_API json_t *GetParameterSetAsJSON (const ParameterSet * const param_set_p, const SchemaVersion * const sv_p, const bool full_definition_flag);
 ...
 * @memberof ParameterSet
 */
GRASSROOTS_SERVICE_MANAGER_API json_t *GetParameterSetSelectionAsJSON (const ParameterSet * const param_set_p, const SchemaVersion * const sv_p, const bool full_definition_flag, void *data_p, bool (*add_param_fn) (const Parameter *param_p, void *data_p));
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API ParameterSet *CreateParameterSetFromJSON (const json_t * const json_p, struct Service *service_p, const bool concise_flag);
 ...
 * @memberof ParameterSet
 */
GRASSROOTS_SERVICE_MANAGER_API Parameter *GetParameterFromParameterSetByName (const ParameterSet * const params_p, const char * const name_s);
 ...
 * @memberof ParameterSet
 */
GRASSROOTS_SERVICE_MANAGER_API ParameterNode *GetParameterNodeFromParameterSetByName (const ParameterSet * const params_p, const char * const name_s);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API ParameterSetNode *AllocateParameterSetNode (ParameterSet *params_p);
 ...
 * @memberof ParameterSetNode
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeParameterSetNode (ListItem *node_p);
 ...
 * @memberof ParameterSet
 */
GRASSROOTS_SERVICE_MANAGER_API Parameter *DetachParameterByName (ParameterSet *params_p, const char * const name_s);
 ...
 * @memberof ParameterSet
 */
GRASSROOTS_SERVICE_MANAGER_API bool DetachParameter (ParameterSet *params_p, Parameter *param_p);
 ...
 * @memberof ParameterSet
 */
GRASSROOTS_SERVICE_MANAGER_API struct ParameterGroup *GetParameterGroupFromParameterSetByGroupName (const ParameterSet * const params_p, const char * const name_s);
 ...
 * @memberof ParameterSet
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddParameterGroupToParameterSet (ParameterSet *param_set_p, ParameterGroup *group_p);


GRASSROOTS_SERVICE_MANAGER_API uint32 GetParameterSetSize (const ParameterSet * const param_set_p);
