 ...
 */
	...
	#define PARAMETER_GROUP_PREFIX GRASSROOTS_SERVICE_MANAGER_API
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API ParameterGroupNode *AllocateParameterGroupNode (ParameterGroup *group_p);
 ...
 * @memberof ParameterGroupNode
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeParameterGroupNode (ListItem *node_p);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API ParameterGroup *AllocateParameterGroup (const char *name_s,  const bool repeatable_flag, const struct ServiceData *service_data_p);
 ...
 * @memberof ParameterGroup
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeParameterGroup (ParameterGroup *param_group_p);
 ...
 * @memberof ParameterGroup
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddParameterGroupAsJSON (ParameterGroup *param_group_p, json_t *groups_array_p, const SchemaVersion * const sv_p);
 ...
 * @memberof ParameterGroup
 */
GRASSROOTS_SERVICE_MANAGER_API json_t *GetParameterGroupAsJSON (const ParameterGroup *param_group_p, const bool include_params_flag, const bool full_definition_flag, const SchemaVersion * const sv_p);
 ...
 * @memberof ParameterGroup
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddParameterGroupChild (ParameterGroup *parent_group_p, ParameterGroup *child_group_p);
 ...
 * @memberof ParameterGroup
 */
GRASSROOTS_SERVICE_MANAGER_API ParameterGroup *CreateAndAddParameterGroupChild (ParameterGroup *parent_group_p, const char *name_s, const bool repeatable_flag, const bool add_params_flag);
 ...
 * @memberof ParameterGroup
 */
GRASSROOTS_SERVICE_MANAGER_API bool RemoveParameterGroupChild (ParameterGroup *parent_group_p, ParameterGroup *child_group_p);
 ...
 * @memberof ParameterGroup
 */
GRASSROOTS_SERVICE_MANAGER_API bool CloneParameters (const ParameterGroup * const src_group_p, ParameterGroup *dest_group_p);
 ...
 * @memberof ParameterGroup
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddParameterToParameterGroup (ParameterGroup *parent_group_p, Parameter *param_p);
 ...
 * @memberof ParameterGroup
 */
GRASSROOTS_SERVICE_MANAGER_API ParameterGroup *CreateAndAddParameterGroupToParameterSet (const char *name_s, const bool repeatable_flag, const struct ServiceData *service_data_p, struct ParameterSet *param_set_p);
 ...
 * @memberof ParameterGroup
 */
GRASSROOTS_SERVICE_MANAGER_API ParameterNode *GetParameterNodeFromParameterGroupByName (const ParameterGroup * const group_p, const char * const name_s);
 ...
 * @memberof ParameterGroup
 */
GRASSROOTS_SERVICE_MANAGER_API Parameter *GetParameterFromParameterGroupByName (const ParameterGroup * const group_p, const char * const name_s);
 ...
 * @memberof ParameterGroup
 */
GRASSROOTS_SERVICE_MANAGER_API char *GetRepeatableParameterGroupName (ParameterGroup * const group_p);
 ...
 * @memberof ParameterGroup
 */
GRASSROOTS_SERVICE_MANAGER_API char *GetRepeatableParameterGroupRegularExpression (const ParameterGroup * const group_p);
 ...
 * @memberof ParameterGroup
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddRepeatableParameterGroupLabelParam (ParameterGroup *group_p, Parameter *param_p);
