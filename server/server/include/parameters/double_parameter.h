 ...
 */
GRASSROOTS_SERVICE_MANAGER_API DoubleParameter *AllocateDoubleParameter (const struct ServiceData *service_data_p, const ParameterType pt, const char * const name_s, const char * const display_name_s, const char * const description_s, const double64 *default_value_p, const double64 *current_value_p, ParameterLevel level);



GRASSROOTS_SERVICE_MANAGER_API DoubleParameter *AllocateDoubleParameterFromJSON (const json_t *param_json_p, const struct Service *service_p, const bool concise_flag);


GRASSROOTS_SERVICE_MANAGER_API void FreeDoubleParameter (DoubleParameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API const double64 *GetDoubleParameterCurrentValue (const DoubleParameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API bool SetDoubleParameterCurrentValue (DoubleParameter *param_p, const double64 *value_p);


GRASSROOTS_SERVICE_MANAGER_API const double64 *GetDoubleParameterDefaultValue (const DoubleParameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API bool SetDoubleParameterDefaultValue (DoubleParameter *param_p, const double64 *value_p);


GRASSROOTS_SERVICE_MANAGER_API bool IsDoubleParameter (const Parameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API bool GetCurrentDoubleParameterValueFromParameterSet (const ParameterSet * const params_p, const char * const name_s, const double64 **value_pp);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API Parameter *EasyCreateAndAddDoubleParameterToParameterSet (const struct ServiceData *service_data_p, ParameterSet *params_p, ParameterGroup *group_p, const ParameterType pt,
 ...
 * @memberof ParameterSet
 */
GRASSROOTS_SERVICE_MANAGER_API Parameter *CreateAndAddDoubleParameterToParameterSet (const struct ServiceData *service_data_p, ParameterSet *params_p, ParameterGroup *group_p, const ParameterType pt,
																								const char * const name_s, const char * const display_name_s, const char * const description_s,
																								const double64 *default_value_p, const double64 *current_value_p, uint8 level);



GRASSROOTS_SERVICE_MANAGER_API bool SetDoubleParameterBounds (DoubleParameter *param_p, const double64 *min_value_p, const double64 *max_value_p);


GRASSROOTS_SERVICE_MANAGER_API bool GetDoubleParameterBounds (const DoubleParameter *param_p, double64 *min_value_p, double64 *max_value_p);


GRASSROOTS_SERVICE_MANAGER_API bool SetDoubleParameterMinimumValue (DoubleParameter *param_p, const double64 *min_value_p);


GRASSROOTS_SERVICE_MANAGER_API bool SetDoubleParameterMaximumValue (DoubleParameter *param_p, const double64 *max_value_p);


GRASSROOTS_SERVICE_MANAGER_API bool SetDoubleParameterCurrentValueFromJSON (DoubleParameter *param_p, const json_t *value_p);
