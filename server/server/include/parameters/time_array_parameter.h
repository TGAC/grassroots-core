 ...
 */
GRASSROOTS_SERVICE_MANAGER_API TimeArrayParameter *AllocateTimeArrayParameter (const struct ServiceData *service_data_p,  const char * const name_s, const char * const display_name_s, const char * const description_s, struct tm **default_values_pp, struct tm **current_values_pp, const size_t num_values, ParameterLevel level);


GRASSROOTS_SERVICE_MANAGER_API TimeArrayParameter *AllocateTimeArrayParameterFromJSON (const json_t *param_json_p, const struct Service *service_p, const bool concise_flag, const ParameterType *pt_p);



GRASSROOTS_SERVICE_MANAGER_API Parameter *EasyCreateAndAddTimeArrayParameterToParameterSet (const ServiceData *service_data_p, ParameterSet *params_p, ParameterGroup *group_p,
																											const char * const name_s, const char * const display_name_s, const char * const description_s,
																											struct tm **default_values_pp, const size_t num_values, uint8 level);

GRASSROOTS_SERVICE_MANAGER_API Parameter *CreateAndAddTimeArrayParameterToParameterSet (const ServiceData *service_data_p, ParameterSet *params_p, ParameterGroup *group_p,
																											const char * const name_s, const char * const display_name_s, const char * const description_s,
																											struct tm **default_values_pp, struct tm **current_values_pp,
																											const size_t num_values, uint8 level);


GRASSROOTS_SERVICE_MANAGER_API char *GetTimeArrayParameterCurrentValuesAsFlattenedString (const TimeArrayParameter *param_p);

GRASSROOTS_SERVICE_MANAGER_API void FreeTimeArrayParameter (TimeArrayParameter *param_p);

GRASSROOTS_SERVICE_MANAGER_API bool IsTimeArrayParameter (const Parameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API const struct tm **GetTimeArrayParameterCurrentValues (const TimeArrayParameter *param_p);

GRASSROOTS_SERVICE_MANAGER_API const struct tm **GetTimeArrayParameterDefaultValues (const TimeArrayParameter *param_p);


GRASSROOTS_SERVICE_MANAGER_API bool SetTimeArrayParameterCurrentValues (TimeArrayParameter *param_p, const struct tm **values_pp, const size_t num_values);


GRASSROOTS_SERVICE_MANAGER_API bool SetTimeArrayParameterDefaultValues (TimeArrayParameter *param_p, const struct tm **values_pp, const size_t num_values);


GRASSROOTS_SERVICE_MANAGER_API size_t GetNumberOfTimeArrayCurrentParameterValues (const TimeArrayParameter *param_p);
