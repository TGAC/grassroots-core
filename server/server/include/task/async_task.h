 ...
 * @memberof AsyncTask
 */
GRASSROOTS_SERVICE_MANAGER_API	AsyncTask *AllocateAsyncTask (const char *name_s, struct AsyncTasksManager *manager_p, bool add_flag);
 ...
 * @memberof AsyncTask
 */
GRASSROOTS_SERVICE_MANAGER_API	void FreeAsyncTask (AsyncTask *task_p);
 ...
 * @memberof AsyncTask
 */
GRASSROOTS_SERVICE_MANAGER_API	bool InitialiseAsyncTask (AsyncTask *task_p, const char *name_s, struct AsyncTasksManager *manager_p, bool add_flag);
 ...
 * @memberof AsyncTask
 */
GRASSROOTS_SERVICE_MANAGER_API	void ClearAsyncTask (AsyncTask *task_p);
 ...
 * @memberof AsyncTask
 */
GRASSROOTS_SERVICE_MANAGER_API void CloseAsyncTask (AsyncTask *task_p);
 ...
 * @memberof AsyncTask
 */
GRASSROOTS_SERVICE_MANAGER_API	bool SetAsyncTaskSyncData (AsyncTask *task_p, SyncData *sync_data_p, MEM_FLAG mem);
 ...
 * @memberof AsyncTask
 */
GRASSROOTS_SERVICE_MANAGER_API	void SetAsyncTaskRunData (AsyncTask *task_p, void *(*run_fn) (void *data_p), void *data_p);
 ...
 * @memberof AsyncTask
 */
GRASSROOTS_SERVICE_MANAGER_API	bool IsAsyncTaskRunning (const AsyncTask *task_p);
 ...
 * @memberof AsyncTask
 */
GRASSROOTS_SERVICE_MANAGER_API	bool RunAsyncTask (AsyncTask *task_p);
 ...
 * successfully, <code>false</code> otherwise.
 */
GRASSROOTS_SERVICE_MANAGER_API	 bool CloseAllAsyncTasks (void);
 ...
 * @memberof AsyncTask
 */
GRASSROOTS_SERVICE_MANAGER_API	AsyncTaskNode *AllocateAsyncTaskNode (AsyncTask *task_p, MEM_FLAG mem);
 ...
 * @memberof AsyncTask
 */
GRASSROOTS_SERVICE_MANAGER_API	void FreeAsyncTaskNode (ListItem *node_p);
 ...
 * @memberof AsyncTask
 */
GRASSROOTS_SERVICE_MANAGER_API void SetAsyncTaskConsumer (AsyncTask *task_p, EventConsumer *consumer_p, MEM_FLAG mem);
 ...
 * @memberof AsyncTask
 */
GRASSROOTS_SERVICE_MANAGER_API void RunEventConsumerFromAsyncTask (AsyncTask *task_p);



GRASSROOTS_SERVICE_MANAGER_API OperationStatus RunProcess (const char *const command_line_s);
