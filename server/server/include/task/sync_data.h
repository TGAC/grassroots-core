 ...
 * @memberof SyncData
 */
GRASSROOTS_SERVICE_MANAGER_API struct SyncData *AllocateSyncData (void);
 ...
 * @memberof SyncData
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeSyncData (struct SyncData *sync_data_p);
 ...
 * @memberof SyncData
 */
GRASSROOTS_SERVICE_MANAGER_API bool AcquireSyncDataLock (struct SyncData *sync_data_p);
 ...
 * @memberof SyncData
 */
GRASSROOTS_SERVICE_MANAGER_API bool ReleaseSyncDataLock (struct SyncData *sync_data_p);
 ...
 * @memberof SyncData
 */
GRASSROOTS_SERVICE_MANAGER_API void WaitOnSyncData (struct SyncData *sync_data_p, bool (*continue_fn) (void *data_p), void *data_p);
 ...
 * @memberof SyncData
 */
GRASSROOTS_SERVICE_MANAGER_API void SendSyncData (struct SyncData *sync_data_p);
