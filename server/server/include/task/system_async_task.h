 ...
 */
GRASSROOTS_SERVICE_MANAGER_API	SystemAsyncTask *AllocateSystemAsyncTask (ServiceJob *job_p, const char *name_s, struct AsyncTasksManager *manager_p, bool add_flag, const char *command_s, void (*on_success_callback_fn) (ServiceJob *job_p));
 ...
 * @memberof SystemAsyncTask
 */
GRASSROOTS_SERVICE_MANAGER_API bool SetSystemAsyncTaskCommand (SystemAsyncTask *task_p, const char *command_s);
 ...
 * @memberof SystemAsyncTask
 */
GRASSROOTS_SERVICE_MANAGER_API	void FreeSystemAsyncTask (SystemAsyncTask *task_p);
 ...
 * @memberof SystemAsyncTask
 */
GRASSROOTS_SERVICE_MANAGER_API bool RunSystemAsyncTask (SystemAsyncTask *task_p);
 ...
 * @memberof SystemAsyncTask
 */
GRASSROOTS_SERVICE_MANAGER_LOCAL void RunSystemAsyncTaskSuccess (SystemAsyncTask *task_p, ServiceJob *job_p);




GRASSROOTS_SERVICE_MANAGER_LOCAL OperationStatus ActualRunSystemAsyncTask (SystemAsyncTask *task_p);
