...
GRASSROOTS_SERVICE_MANAGER_API AsyncTasksManager *AllocateAsyncTasksManager (const char * const name_s, bool (*cleanup_fn) (void *data_p), void *cleanup_data_p);
 ...
 * @memberof AsyncTasksManager
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeAsyncTasksManager (AsyncTasksManager *manager_p);
 ...
 * @memberof AsyncTasksManager
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddAsyncTaskToAsyncTasksManager (AsyncTasksManager *manager_p, AsyncTask *task_p, MEM_FLAG mem);
 ...
 * @memberof AsyncTasksManager
 */
GRASSROOTS_SERVICE_MANAGER_API SystemAsyncTask *AllocateSystemAsyncTaskFromAsyncTasksManager (AsyncTasksManager *manager_p, ServiceJob *std_service_job_p, char *std_command_line_s, void (*on_success_callback_fn) (ServiceJob *job_p));
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API AsyncTasksManagerEventConsumer *AllocateAsyncTasksManagerEventConsumer (void (*consumer_fn) (EventConsumer *consumer_p, struct AsyncTask *task_p), AsyncTasksManager *manager_p);
 ...
 * @memberof AsyncTasksManagerEventConsumer
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeAsyncTasksManagerEventConsumer (AsyncTasksManagerEventConsumer *consumer_p);
 ...
 * @memberof AsyncTasksManager
 */
GRASSROOTS_SERVICE_MANAGER_API void PrepareAsyncTasksManager (AsyncTasksManager *manager_p, const int32 initial_counter_value);
 ...
 * @memberof AsyncTasksManager
 */
GRASSROOTS_SERVICE_MANAGER_API bool StartAsyncTaskManagerWorkers (AsyncTasksManager *manager_p);
 ...
 * @memberof AsyncTasksManager
 */
GRASSROOTS_SERVICE_MANAGER_API bool RunAsyncTasksManagerTasks (AsyncTasksManager *manager_p);
 ...
 * @memberof AsyncTasksManager
 */
GRASSROOTS_SERVICE_MANAGER_API bool IsAsyncTaskManagerRunning (const AsyncTasksManager *manager_p);
 ...
 * @memberof AsyncTasksManager
 */
GRASSROOTS_SERVICE_MANAGER_API void IncrementAsyncTaskManagerCount (AsyncTasksManager *manager_p);
