 ...
 */
GRASSROOTS_SERVICE_MANAGER_API CountAsyncTask *AllocateCountAsyncTask (const char *name_s, struct AsyncTasksManager *manager_p, bool add_flag, int32 limit);
 ...
 * @memberof CountAsyncTask
 */
GRASSROOTS_SERVICE_MANAGER_API bool InitCountAsyncTask (CountAsyncTask *count_task_p, const char *name_s, struct AsyncTasksManager *manager_p, bool add_flag, int32 limit);
 ...
 * @memberof CountAsyncTask
 */
GRASSROOTS_SERVICE_MANAGER_API AsyncTask *GetAsyncTaskFromCountAsyncTask (CountAsyncTask *count_task_p);
 ...
 * @memberof CountAsyncTask
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeCountAsyncTask (CountAsyncTask *count_task_p);
 ...
 * @memberof CountAsyncTask
 */
GRASSROOTS_SERVICE_MANAGER_API void ClearCountAsyncTask (CountAsyncTask *count_task_p);
 ...
 * @memberof CountAsyncTask
 */
GRASSROOTS_SERVICE_MANAGER_API bool IncrementCountAsyncTask (CountAsyncTask *count_task_p);
 ...
 * @memberof CountAsyncTask
 */
GRASSROOTS_SERVICE_MANAGER_API bool ContinueCountAsyncTask (const CountAsyncTask *count_task_p);
 ...
 * @memberof CountAsyncTask
 */
GRASSROOTS_SERVICE_MANAGER_API void SetCountAsyncTaskLimit (CountAsyncTask *task_p, int32 limit);
