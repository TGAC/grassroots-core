 ...
 */
GRASSROOTS_SERVICE_MANAGER_API EventConsumer *AllocateEventConsumer (void (*consumer_fn) (EventConsumer *consumer_p, struct AsyncTask *task_p));
 ...
 * @memberof EventConsumer
 */
GRASSROOTS_SERVICE_MANAGER_API bool InitEventConsumer (EventConsumer *consumer_p, void (*consumer_fn) (EventConsumer *consumer_p, struct AsyncTask *task_p));
 ...
 * @memberof EventConsumer
 */
GRASSROOTS_SERVICE_MANAGER_API void ClearEventConsumer (EventConsumer *consumer_p);
 ...
 * @memberof EventConsumer
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeEventConsumer (EventConsumer *consumer_p);
 ...
 * @memberof EventConsumer
 */
GRASSROOTS_SERVICE_MANAGER_API void RunEventConsumer (EventConsumer *consumer_p, struct AsyncTask *task_p);
