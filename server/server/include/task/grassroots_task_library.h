...
#ifndef GRASSROOTS_TASK_LIBRARY_H
#define GRASSROOTS_TASK_LIBRARY_H
...
*/
  ...
  #ifdef  GRASSROOTS_TASK_LIBRARY_EXPORTS /* defined if we are building the LIB DLL (instead of using it) */
    #define GRASSROOTS_TASK_API LIB_HELPER_SYMBOL_EXPORT
  #else
    #define GRASSROOTS_TASK_API LIB_HELPER_SYMBOL_IMPORT
  #endif /* #ifdef GRASSROOTS_TASK_LIBRARY_EXPORTS */
  #define GRASSROOTS_TASK_LOCAL LIB_HELPER_SYMBOL_LOCAL
...
#endif 	/* #ifndef GRASSROOTS_TASK_LIBRARY_H */
