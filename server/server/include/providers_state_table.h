 ...
 */
GRASSROOTS_SERVICE_MANAGER_API ProvidersStateTable *AllocateProvidersStateTable (const json_t *req_p);
 ...
 * @memberof ProvidersStateTable
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeProvidersStateTable (ProvidersStateTable *providers_p);
 ...
 * @memberof ProvidersStateTable
 */
GRASSROOTS_SERVICE_MANAGER_API ProvidersStateTable *GetInitialisedProvidersStateTable (const json_t *req_p, LinkedList *services_p, GrassrootsServer *grassroots_p);
 ...
 * @memberof ProvidersStateTable
 */GRASSROOTS_SERVICE_MANAGER_API ProvidersStateTable *GetInitialisedProvidersStateTableForSingleService (const json_t *req_p, const char * const server_uri_s, const char * const service_s);
 ...
 * @memberof ProvidersStateTable
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddToProvidersStateTable (ProvidersStateTable *providers_p, const char *server_uri_s, const char *service_s);
 ...
 * @memberof ProvidersStateTable
 */
GRASSROOTS_SERVICE_MANAGER_API bool IsServiceInProvidersStateTable (const ProvidersStateTable *providers_p, const char *server_uri_s, const char *service_s);
 ...
 * @memberof ProvidersStateTable
 */
GRASSROOTS_SERVICE_MANAGER_API json_t *GetProvidersStateTableAsJSON (const ProvidersStateTable *providers_p);
 ...
 * @param user_p An optional User for the current User if access restrictions to any Server-Service
 ...
 * @memberof ProvidersStateTable
 */
GRASSROOTS_SERVICE_MANAGER_API json_t *GetAvailableServicesRequestForAllProviders (const ProvidersStateTable * providers_p, User *user_p, const SchemaVersion * const sv_p);
 ...
 * @memberof ProvidersStateTable
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddServicesListToProvidersStateTable (ProvidersStateTable *providers_p, LinkedList *services_p, GrassrootsServer *grassroots_p);
 ...
 * @memberof ProvidersStateTable
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddProvidersStateTableToRequest (const ProvidersStateTable * providers_p, json_t *req_p);
 ...
 * @memberof ProvidersStateTable
 */
GRASSROOTS_SERVICE_MANAGER_API bool InitProvidersStateTableFromRequest (ProvidersStateTable * const providers_p, const json_t * const req_p);
 ...
 * @memberof ProvidersStateTable
 */
GRASSROOTS_SERVICE_MANAGER_API bool ClearProvidersStateTable (ProvidersStateTable *providers_p);
 ...
 * @memberof ProvidersStateTable
 */
GRASSROOTS_SERVICE_MANAGER_API bool ReinitProvidersStateTable (ProvidersStateTable *providers_p, const json_t * const req_p, const char *server_uri_s, const char *service_name_s);
