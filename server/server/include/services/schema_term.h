...
#ifndef CORE_SHARED_SERVICES_INCLUDE_SCHEMA_TERM_H_
 ...
 * @memberof SchemaTerm
 */
GRASSROOTS_SERVICE_MANAGER_API SchemaTerm *AllocateExtendedSchemaTerm (const char *url_s, const char *name_s, const char *description_s, const char *abbreviation_s);
 ...
 * @memberof SchemaTerm
 */
GRASSROOTS_SERVICE_MANAGER_API SchemaTerm *AllocateSchemaTerm (const char *url_s, const char *name_s, const char *description_s);


GRASSROOTS_SERVICE_MANAGER_API bool SetSchemaTermValues (SchemaTerm *term_p, const char *url_s, const char *name_s, const char *description_s);



GRASSROOTS_SERVICE_MANAGER_API bool DoSchemaTermsMatch (const SchemaTerm *term0_p, const SchemaTerm *term1_p);
 ...
 * @memberof SchemaTerm
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeSchemaTerm (SchemaTerm *term_p);
 ...
 * @memberof SchemaTerm
 */
GRASSROOTS_SERVICE_MANAGER_API void ClearSchemaTerm (SchemaTerm *term_p);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API SchemaTermNode *AllocateSchemaTermNodeByParts (const char *url_s, const char *name_s, const char *description_s);
 ...
 * @memberof SchemaTermNode
 */
GRASSROOTS_SERVICE_MANAGER_API SchemaTermNode *AllocateSchemaTermNode (SchemaTerm *term_p);
 ...
 * @memberof SchemaTermNode
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeSchemaTermNode (ListItem *node_p);
 ...
 * @memberof SchemaTerm
 */
GRASSROOTS_SERVICE_MANAGER_API json_t *GetSchemaTermAsJSON (const SchemaTerm *term_p);
 ...
 * @memberof SchemaTerm
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddSchemaTermToJSON (const SchemaTerm *term_p, json_t *root_p);
 ...
 * @memberof SchemaTerm
 */
GRASSROOTS_SERVICE_MANAGER_API SchemaTerm *GetSchemaTermFromJSON (const json_t *term_json_p);
...
#endif /* CORE_SHARED_SERVICES_INCLUDE_SCHEMA_TERM_H_ */
