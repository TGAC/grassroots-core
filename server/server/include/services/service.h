 ...
 */
	...
	#define PATH_PREFIX GRASSROOTS_SERVICE_MANAGER_API
	#define PATH_VAL(x)	= x
#else
	#define PATH_PREFIX extern GRASSROOTS_SERVICE_MANAGER_API
	#define PATH_VAL(x)
#endif
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API ServicesArray *GetReferrableServicesFromPlugin (Plugin * const plugin_p, UserDetails *user_p, const json_t *service_config_p);
 ...
 * @return The ServicesArray or <code>NULL</code> upon error.
 */
GRASSROOTS_SERVICE_MANAGER_API ServicesArray *GetServicesFromPlugin (Plugin * const plugin_p, UserDetails *user_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API bool InitialiseService (Service * const service_p,
 ...
 * @see se_run_fn
 */
GRASSROOTS_SERVICE_MANAGER_API struct ServiceJobSet *RunService (Service *service_p, ParameterSet *param_set_p, UserDetails *user_p, ProvidersStateTable *providers_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API bool DoesServiceHaveCustomServiceJobSerialisation (struct Service *service_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API struct ServiceJob *CreateSerialisedServiceJobFromService (struct Service *service_p, const json_t *service_job_json_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API json_t *CreateSerialisedJSONForServiceJobFromService (struct Service *service_p, struct ServiceJob *service_job_p, bool omit_results_flag);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API Service *GetServiceByName (GrassrootsServer *grassroots_p, const char * const service_name_s, const char * const service_alias_s);
 ...
 * @see se_match_fn
 */
GRASSROOTS_SERVICE_MANAGER_API ParameterSet *IsServiceMatch (Service *service_p, DataResource *resource_p, Handler *handler_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API const char *GetServiceName (const Service *service_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API const char *GetServiceDescription (const Service *service_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API const char *GetServiceAlias (const Service *service_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API json_t *GetServiceIndexingData (Service *service_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API const char *GetServiceInformationURI (const Service *service_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API ParameterSet *GetServiceParameters (Service *service_p, DataResource *resource_p,  UserDetails *user_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API bool GetParameterTypeForNamedParameter (const struct Service *service_p, const char *param_name_s, ParameterType *pt_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API char *GetServiceUUIDAsString (Service *service_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeService (Service *service_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API void ReleaseService (Service *service_p);
...
GRASSROOTS_SERVICE_MANAGER_API void SetServiceReleaseFunction (Service *service_p, void (*release_fn) (Service *service_p));
 ...
 */
GRASSROOTS_SERVICE_MANAGER_LOCAL void ReleaseServiceData (ServiceData *data_p);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API ServiceNode *AllocateServiceNode (Service *service_p);
 ...
 * @memberof ServiceNode
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeServiceNode (ListItem *node_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API bool CloseService (Service *service_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API json_t *GetServiceAsJSON (Service * const service_p, DataResource *resource_p, UserDetails *user_p, const bool add_id_flag);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API const char *GetServiceIcon (const Service *service_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API const char *GetServiceInformationPage (const Service *service_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API bool DeallocatePluginService (Plugin * const plugin_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API json_t *GetServicesListAsJSON (LinkedList *services_list_p, DataResource *resource_p, UserDetails *user_p, const bool add_service_ids_flag, ProvidersStateTable *providers_p);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API void ReleaseServiceParameters (Service *service_p, ParameterSet *params_p);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeServicesArray (ServicesArray *services_p);
 ...
 * @memberof ServicesArray
 */
GRASSROOTS_SERVICE_MANAGER_API ServicesArray *AllocateServicesArray (const uint32 num_services);
 ...
 * @memberof ServicesArray
 */
GRASSROOTS_SERVICE_MANAGER_LOCAL void AssignPluginForServicesArray (ServicesArray *services_p, Plugin *plugin_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddServiceResponseHeader (Service *service_p, json_t *result_json_p);
 ...
 * @memberof ServicesArray
 */
GRASSROOTS_SERVICE_MANAGER_API ServicesArray *GetReferenceServicesFromJSON (json_t *config_p, const char *plugin_name_s, Service *(*get_service_fn) (json_t *config_p, size_t i, GrassrootsServer *grassroots_p), GrassrootsServer *grassroots_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API OperationStatus GetCurrentServiceStatus (Service *service_p, const uuid_t service_id);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_LOCAL OperationStatus DefaultGetServiceStatus (Service *service_p, const uuid_t service_id);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API bool CreateAndAddPairedService (Service *service_p, struct ExternalServer *external_server_p, const char *remote_service_name_s, const json_t *op_p, const json_t *provider_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddPairedService (Service *service_p, PairedService *paired_service_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API bool CreateAndAddLinkedService (Service *service_p, const json_t *service_config_p, GrassrootsServer *grassroots_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddLinkedService (Service *service_p, LinkedService *paired_service_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API json_t *GetServiceRunRequest (const char * const service_name_s, const ParameterSet *params_p, const SchemaVersion *sv_p, const bool run_flag, const ParameterLevel level);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API json_t *GetServiceRefreshRequest (const char * const service_name_s, const ParameterSet *params_p, const SchemaVersion *sv_p, const bool run_flag, const ParameterLevel level);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API json_t *GetInterestedServiceJSON (Service *service_p, const char *keyword_s, const ParameterSet * const params_p, const bool full_definition_flag);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API void SetServiceJobCustomFunctions (Service *service_p, struct ServiceJob *job_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API bool IsServiceRunning (Service *service_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API void SetServiceRunning (Service *service_p, bool b);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API void SetMetadataForService (Service *service_p, SchemaTerm *category_p, SchemaTerm *subcategory_p);
...
GRASSROOTS_SERVICE_MANAGER_API bool SortServicesListByName (LinkedList *services_list_p);


GRASSROOTS_SERVICE_MANAGER_API json_t *GetBaseServiceDataAsJSON (Service * const service_p, UserDetails *user_p);
 ...
 * @memberof Service
 */
GRASSROOTS_SERVICE_MANAGER_API GrassrootsServer *GetGrassrootsServerFromService (const Service * const service_p);


GRASSROOTS_SERVICE_MANAGER_API json_t *GetServiceRefreshRequestFromJSON (const char * const service_name_s, json_t *param_set_json_p, const SchemaVersion *sv_p, const bool run_flag, const ParameterLevel level);


GRASSROOTS_SERVICE_MANAGER_API json_t *GetServiceRunRequestFromJSON (const char * const service_name_s, json_t *param_set_json_p, const SchemaVersion *sv_p, const bool run_flag, const ParameterLevel level);


GRASSROOTS_SERVICE_MANAGER_API bool DefaultGetParameterTypeForNamedParameter (const char *param_name_s, ParameterType *pt_p, const NamedParameterType *params_p);
 ...
 * <code>false</code> otherwise.
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddServiceJobToService (Service *service_p, ServiceJob *job_p);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API bool RemoveServiceJobFromService (Service *service_p, ServiceJob *job_p);
