 ...
 */
GRASSROOTS_SERVICE_MANAGER_API LinkedService *AllocateLinkedService (const char *linked_service_s, const char *input_key_s, const json_t *mapped_params_json_p, const char * const function_s, const json_t *config_p, GrassrootsServer *grassroots_p);
 ...
 * @memberof LinkedService
 */
GRASSROOTS_SERVICE_MANAGER_API LinkedService *CreateLinkedServiceFromJSON (struct Service *service_p, const json_t *linked_service_json_p, GrassrootsServer *grassroots_p);
 ...
 * @memberof LinkedService
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeLinkedService (LinkedService *linked_service_p);
 ...
 * @memberof LinkedService
 */
GRASSROOTS_SERVICE_MANAGER_API LinkedServiceNode *AllocateLinkedServiceNode (LinkedService *linked_service_p);
 ...
 * @memberof LinkedService
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeLinkedServiceNode (ListItem *node_p);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API bool CreateAndAddMappedParameterToLinkedService (LinkedService *linked_service_p, const char *input_s, const char *output_s, bool required_flag, bool multi_flag);
 ...
 * @memberof LinkedService
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddMappedParameterToLinkedService (LinkedService *linked_service_p, struct MappedParameter *mapped_param_p);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API struct MappedParameter *GetMappedParameterByInputParamName (const LinkedService *linked_service_p, const char * const name_s);
 ...
 * @memberof LinkedService
 */
GRASSROOTS_SERVICE_MANAGER_API json_t *GetLinkedServiceAsJSON (LinkedService *linked_service_p);
 ...
 * @memberof LinkedService
 */
GRASSROOTS_SERVICE_MANAGER_API bool ProcessLinkedService (LinkedService *linked_service_p, struct ServiceJob *job_p);
 ...
 * @memberof LinkedService
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddLinkedServiceToRequestJSON (json_t *request_p, LinkedService *linked_service_p, ParameterSet *output_params_p);




GRASSROOTS_SERVICE_MANAGER_API bool RunCustomLinkedServiceGenerator (struct LinkedService *linked_service_p, json_t *data_p, struct ServiceJob *job_p);
