 ...
 */
GRASSROOTS_SERVICE_MANAGER_API ServiceJobSetIterator *AllocateServiceJobSetIterator (ServiceJobSet *set_p);
 ...
 * @memberof ServiceJobSetIterator
 */
GRASSROOTS_SERVICE_MANAGER_API void InitServiceJobSetIterator (ServiceJobSetIterator *iterator_p, ServiceJobSet *set_p);
 ...
 * @memberof ServiceJobSetIterator
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeServiceJobSetIterator (ServiceJobSetIterator *iterator_p);
 ...
 * @memberof ServiceJobSetIterator
 */
GRASSROOTS_SERVICE_MANAGER_API ServiceJob *GetNextServiceJobFromServiceJobSetIterator (ServiceJobSetIterator *iterator_p);
 ...
 * @memberof ServiceJobSetIterator
 */
GRASSROOTS_SERVICE_MANAGER_API bool HasServiceJobSetIteratorFinished (const ServiceJobSetIterator *iterator_p);
