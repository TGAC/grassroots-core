...
struct LinkedService;
	...
	#define SERVICE_JOB_PREFIX GRASSROOTS_SERVICE_MANAGER_API
	#define SERVICE_JOB_VAL(x)	= x
#else
	#define SERVICE_JOB_PREFIX extern GRASSROOTS_SERVICE_MANAGER_API
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeServiceJob (ServiceJob *job_p);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeBaseServiceJob (ServiceJob *job_p);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API ServiceJob *AllocateServiceJob (struct Service *service_p, const char *job_name_s, const char *job_description_s, bool (*update_fn) (struct ServiceJob *job_p), bool (*calculate_results_fn) (struct ServiceJob *job_p), void (*free_job_fn) (struct ServiceJob *job_p), const char *job_type_s);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API ServiceJob *CreateAndAddServiceJobToService (struct Service *service_p, const char *job_name_s, const char *job_description_s, bool (*update_fn) (struct ServiceJob *job_p), bool (*calculate_results_fn) (struct ServiceJob *job_p), void (*free_job_fn) (struct ServiceJob *job_p));
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API bool InitServiceJob (ServiceJob *job_p, struct Service *service_p, const char *job_name_s, const char *job_description_s, bool (*update_fn) (struct ServiceJob *job_p), bool (*calculate_results_fn) (struct ServiceJob *job_p), void (*free_job_fn) (struct ServiceJob *job_p), uuid_t *id_p, const char *job_type_s);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API void ClearServiceJob (ServiceJob *job_p);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API ServiceJob *CloneServiceJob (const ServiceJob *src_p);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API bool CopyServiceJob (const ServiceJob *src_p, ServiceJob *dest_p);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API struct Service *GetServiceFromServiceJob (ServiceJob *job_p);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API ServiceJobNode *FindServiceJobNodeInServiceJobSet (const ServiceJobSet *job_set_p, const ServiceJob *job_p);


GRASSROOTS_SERVICE_MANAGER_API bool IsServiceJobInServiceJobSet (const ServiceJobSet *job_set_p, const ServiceJob *job_p);
 ...
 * @memberof ServiceJobSet
 */
GRASSROOTS_SERVICE_MANAGER_API ServiceJobNode *FindServiceJobNodeByUUIDInServiceJobSet (const ServiceJobSet *job_set_p, const uuid_t job_id);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API bool RemoveServiceJobByUUIDFromServiceJobSet (ServiceJobSet *job_set_p, uuid_t job_id);
 ...
 * @memberof ServiceJobSet
 */
GRASSROOTS_SERVICE_MANAGER_API bool RemoveServiceJobFromServiceJobSet (ServiceJobSet *job_set_p, ServiceJob *job_p);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API bool SetServiceJobDescription (ServiceJob *job_p, const char * const description_s);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API bool SetServiceJobURL (ServiceJob *job_p, const char * const url_s);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API bool SetServiceJobName (ServiceJob *job_p, const char * const name_s);
 ...
 * @see InitServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API ServiceJobSet *AllocateServiceJobSet (struct Service *service_p);
 ...
 * @see InitServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API ServiceJobSet *AllocateSimpleServiceJobSet (struct Service *service_p, const char *job_name_s, const char *job_description_s);
 ...
 * @memberof ServiceJobSet
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeServiceJobSet (ServiceJobSet *job_set_p);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API ServiceJobNode *AllocateServiceJobNode (ServiceJob *job_p);
 ...
 * @memberof ServiceJobNode
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeServiceJobNode (ListItem *service_job_node_p);
 ...
 * @memberof ServiceJobSet
 */
GRASSROOTS_SERVICE_MANAGER_API ServiceJob *GetServiceJobFromServiceJobSetById (const ServiceJobSet *jobs_p, const uuid_t job_id);
 ...
 * @memberof ServiceJobSet
 */
GRASSROOTS_SERVICE_MANAGER_API json_t *GetServiceJobSetAsJSON (const ServiceJobSet *jobs_p, bool omit_results_flag);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API json_t *GetServiceJobAsJSON (ServiceJob * const job_p, bool omit_results_flag);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API json_t *GetServiceJobStatusAsJSON (ServiceJob *job_p, bool omit_results_flag);
 ...
 * @memberof ServiceJobSet
 */
GRASSROOTS_SERVICE_MANAGER_API bool ProcessServiceJobSet (ServiceJobSet *jobs_p, json_t *res_p);
 ...
 *
 */
GRASSROOTS_SERVICE_MANAGER_API ServiceJob *CreateServiceJobFromJSON (const json_t *job_json_p, GrassrootsServer *grassroots_p);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API bool InitServiceJobFromJSON (ServiceJob *job_p, const json_t *json_p, struct Service *service_p, GrassrootsServer *grassroots_p);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API OperationStatus GetServiceJobStatus (ServiceJob *job_p);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API OperationStatus GetCachedServiceJobStatus (const ServiceJob *job_p);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API const char *GetServiceJobName (const ServiceJob *job_p);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API bool CloseServiceJob (ServiceJob *job_p);
 ...
 * @memberof ServiceJobSet
 */
GRASSROOTS_SERVICE_MANAGER_API ServiceJob *GetServiceJobFromServiceJobSet (const ServiceJobSet *jobs_p, const uint32 index);
 ...
 * @memberof ServiceJobSet
 */
GRASSROOTS_SERVICE_MANAGER_API uint32 GetServiceJobSetSize (const ServiceJobSet * const jobs_p);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API void ClearServiceJobResults (ServiceJob *job_p, bool free_memory_flag);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API char *SerialiseServiceJobToJSON (ServiceJob * const job_p, bool omit_results_flag);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API ServiceJob *CreateServiceJobFromResultsJSON (const json_t *results_p, struct Service *service_p, const char *name_s, const char *description_s, OperationStatus status, const char *job_type_s);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API bool InitServiceJobFromResultsJSON (ServiceJob *job_p, const json_t *results_p, struct Service *service_p, const char *name_s, const char *description_s, OperationStatus status, const char *job_type_s);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddParameterErrorMessageToServiceJob (ServiceJob *job_p, const char * const param_s, const ParameterType param_type, const char * const value_s);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddGeneralErrorMessageToServiceJob (ServiceJob *job_p, const char * const value_s);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddCompoundErrorToServiceJob (ServiceJob *job_p, const char *param_s, const ParameterType param_type, json_t *error_details_p);


GRASSROOTS_SERVICE_MANAGER_API bool AddTabularParameterErrorMessageToServiceJob (ServiceJob *job_p, const char * const param_s, const ParameterType param_type, const char * const value_s, const uint32 row, const char *column_s);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddResultToServiceJob (ServiceJob *job_p, json_t *result_p);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API void SetServiceJobStatus (ServiceJob *job_p, OperationStatus status);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API void SetServiceJobUpdateFunction (ServiceJob *job_p, bool (*update_fn) (ServiceJob *job_p));
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API void SetServiceJobFreeFunction (ServiceJob *job_p, void (*free_fn) (ServiceJob *job_p));
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API void SetServiceJobCalculateResultFunction (ServiceJob *job_p, bool (*calculate_fn) (ServiceJob *job_p));
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API bool UpdateServiceJob (ServiceJob *job_p);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API uint32 GetNumberOfServiceJobResults (const ServiceJob *job_p);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API bool ReplaceServiceJobResults (ServiceJob *job_p, json_t *results_p);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddLinkedServiceToServiceJob (ServiceJob *job_p, struct LinkedService *linked_service_p);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API void ProcessLinkedServices (ServiceJob *job_p);
 ...
 * @memberof ServiceJob */
GRASSROOTS_SERVICE_MANAGER_API bool CalculateServiceJobResult (ServiceJob *job_p);
 ...
 * @memberof ServiceJob
 */
GRASSROOTS_SERVICE_MANAGER_API void SetServiceJobUUID (ServiceJob *job_p, const uuid_t new_job_id);



GRASSROOTS_SERVICE_MANAGER_LOCAL int32 GetNumberOfLiveJobsFromServiceJobSet (const ServiceJobSet *jobs_p);



GRASSROOTS_SERVICE_MANAGER_LOCAL bool GetOperationStatusFromServiceJobJSON (const json_t *value_p, OperationStatus *status_p);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API void MergeServiceJobStatus (ServiceJob *job_p, OperationStatus status);
