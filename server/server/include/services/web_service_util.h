 ...
 */
GRASSROOTS_SERVICE_MANAGER_API SubmissionMethod GetSubmissionMethod (const json_t *op_json_p);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API bool InitWebServiceData (WebServiceData * const data_p, json_t *op_json_p);
 ...
 * @memberof WebServiceData
 */
GRASSROOTS_SERVICE_MANAGER_API void ClearWebServiceData (WebServiceData * const data_p);
 ...
 * @memberof WebServiceData
 */
GRASSROOTS_SERVICE_MANAGER_API bool CallCurlWebservice (WebServiceData *data_p);
 ...
 * @memberof WebServiceData
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddParametersToGetWebService (WebServiceData *data_p, ParameterSet *param_set_p);
 ...
 * @memberof WebServiceData
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddParametersToPostWebService (WebServiceData *data_p, ParameterSet *param_set_p);
 ...
 * @memberof WebServiceData
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddParametersToBodyWebService (WebServiceData *data_p, ParameterSet *param_set_p);
 ...
 * @return <code>true</code> if successful, <code>false</code> otherwise.
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddMatchTypeParameter (WebServiceData *data_p, ParameterSet *param_set_p);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API MatchType GetMatchTypeParameterValue (ParameterSet * const param_set_p);
