 ...
 */
GRASSROOTS_SERVICE_MANAGER_API const char *GetProviderName (const json_t * const data_p);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API const char *GetProviderURI (const json_t * const data_p);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API const char *GetProviderDescription (const json_t * const data_p);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API const char *GetProviderLogo (const json_t * const data_p);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API json_t *GetProviderDetails (const json_t *root_json_p);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API bool SetProviderType (json_t *provider_p);
