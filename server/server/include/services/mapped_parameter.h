 ...
 */
GRASSROOTS_SERVICE_MANAGER_API MappedParameter *AllocateMappedParameter (const char *input_s, const char *output_s, bool required_flag, bool multi_flag);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API MappedParameter *CreateMappedParameterFromJSON (const json_t *mapped_param_json_p);
 ...
 * @memberof MappedParameter
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeMappedParameter (MappedParameter *mapped_param_p);
 ...
 * @memberof MappedParameter
 */
GRASSROOTS_SERVICE_MANAGER_API MappedParameterNode *AllocateMappedParameterNode (MappedParameter *mapped_param_p);
 ...
 * @memberof MappedParameter
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeMappedParameterNode (ListItem *node_p);
 ...
 * @memberof MappedParameter
 */
GRASSROOTS_SERVICE_MANAGER_API bool SetMappedStringParameterValue (MappedParameter *mapped_param_p, ParameterSet *params_p, const char *param_name_s);
