 ...
 * @memberof ProvidersStateTable
 */
GRASSROOTS_SERVICE_MANAGER_API json_t *GetAvailableServicesRequestForAllProviders (const ProvidersStateTable * providers_p, UserDetails *user_p, const SchemaVersion * const sv_p);
