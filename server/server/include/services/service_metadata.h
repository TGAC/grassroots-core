 ...
 */
GRASSROOTS_SERVICE_MANAGER_API ServiceMetadata *AllocateServiceMetadata (SchemaTerm *category_p, SchemaTerm *subcategory_p);
 ...
 * @memberof ServiceMetadata
 */
GRASSROOTS_SERVICE_MANAGER_API void FreeServiceMetadata (ServiceMetadata *metadata_p);
 ...
 * @memberof ServiceMetadata
 */
GRASSROOTS_SERVICE_MANAGER_API void ClearServiceMetadata (ServiceMetadata *metadata_p);
 ...
 * @memberof ServiceMetadata
 */
GRASSROOTS_SERVICE_MANAGER_API void SetServiceMetadataValues (ServiceMetadata *metadata_p, SchemaTerm *category_p, SchemaTerm *subcategory_p);
 ...
 * @memberof ServiceMetadata
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddServiceMetadataToJSON (const ServiceMetadata *metadata_p, json_t *service_json_p);
 ...
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddSchemaTermToServiceMetadataInput (ServiceMetadata *metadata_p, SchemaTerm *term_p);
 ...
 * @return ServiceMetadata
 */
GRASSROOTS_SERVICE_MANAGER_API bool AddSchemaTermToServiceMetadataOutput (ServiceMetadata *metadata_p, SchemaTerm *term_p);
 ...
 * @memberof ServiceMetadata
 */
GRASSROOTS_SERVICE_MANAGER_API ServiceMetadata *GetServiceMetadataFromJSON (const json_t *service_json_p);
